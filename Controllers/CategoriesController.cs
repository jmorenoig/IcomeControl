...
namespace IcomeControl.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NameCategory,Type,State")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NameCategory,Type,State")] Category category)
        {
            if (id != category.Id)
            {
                return NotFound();
